...

{
  ...
  is($Class::Rebless::Accounting::CALLS,
      2 ** 4 - 1  # basic depth-4 tree
      - (2 ** 3 - 1)  # since right isn't entered
      - (2 ** 2 - 1)  # and neither is left->left
  );
  # XXX fails - got 7, expected 5; trace shows two bogus 'seen's.
}
